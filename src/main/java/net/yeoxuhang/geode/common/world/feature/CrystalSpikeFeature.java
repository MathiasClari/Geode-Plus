...
import net.yeoxuhang.geode.common.block.QuartzCrystalBlock;
        ...
        while(true) {
            ...
            for(int var11 = 0; var11 < var10; ++var11) {
                ...
                if (random.nextBoolean() && world.isStateAtPosition(relative, DripstoneUtils::isEmptyOrWater) && world.getBlockState(pos).equals(config.crystal_state)) {
                    this.setBlock(world, relative, (BlockState)((BlockState)((BlockState)config.cluster_state.setValue(QuartzCrystalBlock.FACING, direction)).setValue(QuartzCrystalBlock.WATERLOGGED, world.getFluidState(relative).getType() == Fluids.WATER)));
                }
            }
        }
    }
