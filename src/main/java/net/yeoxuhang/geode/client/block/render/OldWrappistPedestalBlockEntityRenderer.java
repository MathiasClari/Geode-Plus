package net.yeoxuhang.geode.client.block.render;
...
public class OldWrappistPedestalBlockEntityRenderer<T extends WrappistPedestalBlockEntity> implements BlockEntityRenderer<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GeodeMod.MOD_ID, "wrappistpedestalblockentitymodel"), "main");
